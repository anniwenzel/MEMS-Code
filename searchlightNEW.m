...
function [found,light_MEMS,light_image,light_int,light_snap] = searchlightNEW(searchpts,light_thresh,gain,exposure,vid,mMTIDevice,NumberBrightPixels) %,mMTIDevice
