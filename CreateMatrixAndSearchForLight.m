...
function [found,light_MEMS,light_image,light_int,snap] = CreateMatrixAndSearchForLight(xpts,ypts,minsep,light_thresh,gain,exposure,vid,mMTIDevice) %,mMTIDevice
 for n_search=[2 5 10 20] % size of search matrix (squared) - granularity of searches                    
        ...
        [found,light_MEMS,light_image,light_int,snap] = searchlightNEW(searchpts1,light_thresh,gain,exposure,vid,mMTIDevice); %,mMTIDevice
